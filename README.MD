...
* <a href="https://skplanet.github.io/sweetswipe/demo/swipe_circular_stepmover.html" target="_blank">Circular demo</a>
...
| bMouseEventSupport | PC에서 사용할대 마우스 이벤트에 스와이핑 기능이 필요하다면 true |
...
## Usage of Circular swiping(무한 롤링)
